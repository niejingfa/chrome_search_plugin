## 信息员 制作划词快速搜索 http://in4.rccchina.com/fg/tasks/30750 by hesy.he
...
RCC_REACH.mouseup =(evt) ->
  ...
  if jQuery("#reach-plugin-control-panel").length==0
    ...
    html = "<div><button id='btn-search-bid-or-project'>搜索公告/项目</button><br><button id='btn-search-firm'>搜索公司</button><br><button id='btn-search-contact'>搜索联系人</button></div> "
